...
The way **UInv** works is that there are two objects, "**bags**" and "**items**".  "**Bags**" are containers that have their own properties that you can customize.  Bags can also contain "**items**", which are collections of properties which you can pre-define in the code, and then easily create, move from bag to bag, delete, etc...
